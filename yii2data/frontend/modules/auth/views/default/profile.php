            ...
            <div class="image-uploader">
                ...
                <div class="image-actions">
                    <span class="btn btn-primary btn-file"
                          data-original-title="<?= Yii::t('art/auth', 'Change profile picture') ?>" 
                          data-toggle="tooltip"
                          data-placement="left">
                    ...
                    Html::submitButton('<i class="fa fa-save fa-lg"></i>', [
                        ...
                        'data-original-title' => Yii::t('art/auth', 'Save profile picture'),
                        'data-toggle' => 'tooltip',
                        'data-placement' => 'top',
                    ])
                    ?>
                    ...
                    <span class="btn btn-primary image-remove"
                          ...
                          data-original-title="<?= Yii::t('art/auth', 'Remove profile picture') ?>" 
                          data-toggle="tooltip"
            ...
            <div class="oauth-services">
                <div class="oauth-authorized-services">
                    <div class="label label-primary space-down"
                         data-original-title="<?= Yii::t('art/auth', 'Click to unlink service') ?>" 
                         data-toggle="tooltip"
                         data-placement="right">
                ...
                <div>
                    <div class="label label-primary space-down"
                         data-original-title="<?= Yii::t('art/auth', 'Click to connect with service') ?>" 
                         data-toggle="tooltip"
                         data-placement="right">
